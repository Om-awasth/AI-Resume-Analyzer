...
- **ML/NLP:** JavaScript token-based similarity scoring
- **Database:** Local JSON storage (`data/app.json`)
- **Frontend:** Nunjucks templates with vanilla JavaScript
- **Deployment:** Local runtime (`npm start`)
